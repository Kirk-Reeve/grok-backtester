...
def test_run_parallel_backtests(mocker):
    ...
    strategy_config = {'type': 'moving_average', 'params': {'short_window': 2, 'long_window': 3}}
    backtest_config = {'initial_capital': 100000, 'commission': 0.001, 'slippage': 0.0005, 'parallel': False}  # Fix: Sequential for mock compatibility
...
def test_run_parallel_backtests_invalid_strategy():
    ...
    backtest_config = {'initial_capital': 100000, 'commission': 0.001, 'slippage': 0.0005, 'parallel': False}
